...
public class ComandView {
	...
	public void printFirstMenu() {
		 ...
		 * switch(next){ case 1: this.createSurvey();break; case 2:
		 * this.createTest();break; case 3: this.display(0);break; case 4:
		 * this.display(1);break; case 5: case 6: control.save();break; case 7:
		 * this.mofify(0);break; case 8: this.mofify(1);break; case 9:
		 * this.answer(0);break; case 10:this.answer(1);break; case
		 * 11:this.displayOutcome(0);break; case
		 * 12:this.displayOutcome(1);break; case 13:System.exit(0); }
		 */
		// our new addition
		String s = "1) Create a new Survey\n" + "2) Create a new Test\n" + "3) Display Survey\n"
				+ "4) Display a Test \n" + "5) Save a Survey\n" + "6) Save a Test \n" + "7) Modify a Survey\n"
				+ "8) Modify a Test\n" + "9) Take a Survey\n" + "10)Take a Test\n" + "11)Look survey outcome\n"
				+ "12)Look test outcome\n" + "13) Quit\n";
...
import MVC.control.MenuControl;
